...
var mac_address, user_name, password,
    ...
    panel_urls=["https://quzutv.net/CNdvBMKcnS","https://quzutv.net/CNdvBMKcnS"],
    panel_url="https://quzutv.net/CNdvBMKcnS",
...
var lg_version='1.0.0',has_playlist=true, demo_url, terms_accepted=0;
var focus_colors=[], epg_colors=[], bg_focus_colors=[], keyboard_displayed=false;
var env='develop';
env='production';
var device_id='';
...
function assignColorCode(color, kind){
    ...
    if(kind==='focus'){
        cssText=
            '\
                .border-focus.active, .active .sub-border-focus {border-color: '+color+' !important;}\
                .active .sub-bg-focus {background: '+color+' !important;}\
            '
    }
    else if(kind==='epg'){
        cssText=
            '\
                .epg-txt-color {color: '+color+'!important;}\
            \
            '
    }
        ...
        cssText=
            '\
                .bg-focus.active {background: '+color+' !important;}\
                .active .sub-bg-focus {background: '+color+' !important;}\
            '
    }
